...
- Comment only non-obvious test intent, fixture constraints, or workarounds. Test names and steps should explain the behavior under test; comments must not restate the assertion.
