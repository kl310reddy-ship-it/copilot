...
- Use comments in CSS only to explain a non-obvious design constraint or intentional exception; do not annotate utilities by repeating what the class list already communicates.
